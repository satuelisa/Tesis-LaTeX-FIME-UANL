...
\begin{tabular}{p{35mm}p{20mm}p{12mm}p{20mm}p{35mm}}
	...
	\multicolumn{2}{c}{Asesora}  & & \multicolumn{2}{c}{Asesor} \\ [13mm]
	\cline{1-2} \cline{4-5} \\ [-3mm]
	\multicolumn{2}{c}{\revisorB} & & \multicolumn{2}{c}{\revisorC} \\
	\multicolumn{2}{c}{Revisora}   & & \multicolumn{2}{c}{Revisor} \\ [13mm]
	\cline{2-4} \\ [-3mm]
	& \multicolumn{3}{c}{\revisorD} & \\
	& \multicolumn{3}{c}{Revisora}   & \\ [17mm]
...
\begin{tabular}{p{37mm}p{21mm}p{12mm}p{21mm}p{37mm}}
	...
	\multicolumn{2}{c}{Revisor}   & & \multicolumn{2}{c}{Revisor} \\
	& \multicolumn{3}{c}{Vo\. Bo.} & \\[100mm]
	\cline{2-4}
	& \multicolumn{3}{c}{\vobo}   & \\
	& \multicolumn{3}{c}{Subdirector de Estudios de Posgrado}   & \\ &&&&
\end{tabular}
